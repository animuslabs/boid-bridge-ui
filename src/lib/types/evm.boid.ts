import {Action, Checksum160Type, NameType, UInt64Type, UInt8Type} from '@wharfkit/antelope'
import {
    ABI,
    Asset,
    Blob,
...
export type RowType<T> = T extends keyof TableTypes ? TableTypes[T] : unknown
