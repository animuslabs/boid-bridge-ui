...
export class Contract extends BaseContract {
  ...
  override action<T extends ActionNames>(
    name:T,
  ...
  override table<T extends TableNames>(name:T, scope?:NameType):Table<RowType<T>> {
...
export namespace ActionParams {
    ...
    export interface authinit {[key: string]: unknown}
    ...
    export interface configclear {[key: string]: unknown}
    ...
    export interface globalclear {[key: string]: unknown}
    ...
    export interface offerclean {[key: string]: unknown}
    ...
    export interface thisround {[key: string]: unknown}
...
export namespace Types {
    ...
    export class AtomicValue extends Variant {
      declare value:| Int8Type | Int8Type[]
            | Int16Type
            | Int32Type
            | Int64Type
            | UInt8Type
